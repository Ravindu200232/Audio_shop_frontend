    ...
    <header className="w-full h-[100px] shadow-xl flex justify-center items-center relative bg-accent">
      ...
      <div className="w-[450px] h-full flex justify-center items-center">
        <div className="w-[390px] h-[40px] bg-gray-300 rounded-3xl flex relative justify-center items-center">
          ...
          <input
            type="text"
            className="w-[330px] h-[30px] ml-3 text-[18px] bg-gray-300 outline-none"
          ></input>
        </div>
      </div>
      <div className="w-[300px] h-full flex items-center justify-center text-white">
        <Link to="/" className="  m-4 text-[18px] hover:text-gray-400">
          Home
        </Link>
        <Link to="/contact" className=" m-4 text-[18px]  hover:text-gray-400">
          contact
        </Link>
        <Link to="/gallery" className=" m-4 text-[18px]  hover:text-gray-400">
          gallery
        </Link>
        <Link to="/item" className="  m-4 text-[18px]  hover:text-gray-400">
          item
        </Link>
      </div>
